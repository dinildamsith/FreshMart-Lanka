...
export default function UserMetaCard(props:any) {
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            >
              <img src={props.userDeatils.userImage} alt="user" className="w-full h-full object-cover"/>
            </div>

            <div className="order-3 xl:order-2">
              <h4 className="mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
                {props.userDeatils?.firstName}{props.userDeatils?.lastName}
              </h4>
            </div>
            ...
            {isPopupOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                  <div className="bg-white p-6 rounded-lg shadow-xl w-96">
                    ...
                    <div className="mb-4 ">
                      <label className="w-10 flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-lg cursor-pointer">
        ...
        <div className="mt-[2rem] p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          ...
          <div
            ...
            <form className="flex flex-col">
              ...
              <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                ...
                <Button size="sm" onClick={handleSave1}>
                  Save Changes
                </Button>
              </div>
            </form>
